...
q18 = c(
  ...
  "The code will create a function called `make_scatter` but will not actually run the code",
  "The code will create a function called `make_scatter` and will run the code",
